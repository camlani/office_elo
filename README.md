# Office Elo Derived from Angular2-Meteor Boilerplate

## About

Office Elo is a web application based tool designed for teams or groups of people to log matches in a web-format. 
...
- `$ npm install` - Intall the application. 
